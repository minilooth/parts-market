...
import {TransmissionTypeSchema} from '@core/schemas/transmission-type';

export const TransmissionTypesTabForm: React.FC<SettingsTabFormProps<TransmissionType>> = ({selection, onSave, onDelete}) => {
  const methods = useForm({mode: 'onChange', resolver: yupResolver(TransmissionTypeSchema)})
      ...
      <Stack flex={0.5}>
        ...
        <Stack direction="row" alignItems="end" height={32}>
          <Typography variant="subtitle1" lineHeight={1} flexGrow={1}>
            {selection ? 'Edit an existing transmission type:' : 'Create new transmission type:'}
          </Typography>
        </Stack>
        ...
        <DeleteConfirmationDialog
          ...
          buttonText="I understand the consequences, delete this transmission type"
          open={dialogOpened}
        ...
        >
          <Stack spacing={1}>
            <Typography variant="body2" textAlign="justify">
              This action <b>cannot</b> be undone. This will permanently delete transmission type and all other entities which linked
              with them.
            </Typography>
